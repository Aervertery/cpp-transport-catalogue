...
namespace renderer {
    ...
    class MapRenderer {
    public:
        MapRenderer(transportcatalogue::json_reader::input::RenderSettings settings, std::ostream& output);
        ...
        svg::Text DrawStopName(ObjectData& data) const;

        svg::Text DrawStopNameUnderlayer(ObjectData& data) const;

        svg::Text DrawBusName(ObjectData& data, size_t color_count) const;
